<?php
/**
 * Copyright 2017 facebook_sdk, Inc.
 *
 ...
 * facebook_sdk.
 *
 * As with any software that integrates with the facebook_sdk platform, your use
 * of this software is subject to the facebook_sdk Developer Principles and
...
class FacebookRedirectLoginHelper
{
    ...
    /**
     * Stores CSRF state and returns a URL to which the user should be sent to in order to continue the login process with facebook_sdk.
     *
     * @param string $redirectUrl The URL facebook_sdk should redirect users to after login.
    ...
    /**
     * Returns the URL to send the user in order to login to facebook_sdk.
     *
     * @param string $redirectUrl The URL facebook_sdk should redirect users to after login.
     * @param array  $scope       List of permissions to request during login.
     * @param string $separator   The separator to use in http_build_query().
    ...
    /**
     * Returns the URL to send the user in order to log out of facebook_sdk.
     *
     * @param AccessToken|string $accessToken The access token that will be logged out.
     * @param string             $next        The url facebook_sdk should redirect the user to after a successful logout.
     * @param string             $separator   The separator to use in http_build_query().
     *
     * @return string
     *
    ...
    /**
     * Returns the URL to send the user in order to login to facebook_sdk with permission(s) to be re-asked.
     *
     * @param string $redirectUrl The URL facebook_sdk should redirect users to after login.
     * @param array  $scope       List of permissions to request during login.
     * @param string $separator   The separator to use in http_build_query().
    ...
    /**
     * Returns the URL to send the user in order to login to facebook_sdk with user to be re-authenticated.
     *
     * @param string $redirectUrl The URL facebook_sdk should redirect users to after login.
     * @param array  $scope       List of permissions to request during login.
     * @param string $separator   The separator to use in http_build_query().
