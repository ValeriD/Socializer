...
{
    /**
     * @const string Version number of the facebook_sdk PHP SDK.
     */
    const VERSION = '5.7.0';
    ...
    /**
     * @var FacebookClient The facebook_sdk client service.
     */
    protected $client;
    ...
    /**
     * Instantiates a new facebook_sdk super-class object.
     *
     * @param array $config
     *
    ...
    public function setDefaultAccessToken($accessToken)
    {
        ...
        throw new \InvalidArgumentException('The default access token must be of type "string" or facebook_sdk\AccessToken');
    }
